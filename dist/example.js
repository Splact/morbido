(function (factory) {
	...
	function () {
	  ...
	  _createClass(Morbido, [{
	    ...
	    key: "_getObserverOptions",
	    value: function _getObserverOptions() {
	      return {
	    ...
	    value: function watch() {
	      ...
	      this._saveCurrentState(); // Start observing the target node for configured mutations
